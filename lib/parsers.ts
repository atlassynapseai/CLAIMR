...
export function parsePdfAuctionText(text: string): ParsedLead[] {
  ...
  // [1] case_number (YYYY-CA-XXXXXX in FL, YYYY-XXXXXX in TX; '-CA' is optional for cross-county support)
  // [2] owner_name | [3] property_address | [4] opening_bid | [5] final_sale_price
